...
const COPY = {
  ru: {
    ...
    stock: { k: 'Наличие', t: 'В наличии. Всегда.', d: 'Любой объём — на нашем складе в Ташкенте. Ждать не нужно.' },
  ...
  uz: {
    ...
    stock: { k: 'Mavjudlik', t: 'Doim mavjud.', d: 'Istalgan hajm — Toshkentdagi omborimizda. Kutish shart emas.' },
