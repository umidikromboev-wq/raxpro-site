...
const COPY = {
  ru: {
    ...
    stock: { k: 'Наличие', t: 'В наличии. Всегда.', d: '150 тонн на нашем складе в Ташкенте — любой объём. По Ташкенту привезём завтра.' },
  ...
  uz: {
    ...
    stock: { k: 'Mavjudlik', t: 'Doim mavjud.', d: 'Toshkent omborimizda 150 tonna — istalgan hajm. Toshkent boʻyicha ertaga yetkazamiz.' },
