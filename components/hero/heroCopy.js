...
export const HERO_COPY = {
  ru: {
    ...
    text: 'Проектируем, поставляем со склада и монтируем стеллажи по всему Узбекистану. Нагрузка до 4 тонн · гарантия 10 лет по договору.',
    cta1: 'Узнать вместимость моего склада', cta2: 'Смотреть каталог',
    chips: ['Бесплатный замер и проект', 'До 300 м² под ключ за 1 день', 'Рассрочка и лизинг'],
  ...
  uz: {
    ...
    text: 'Butun Oʻzbekiston boʻylab stellajlarni loyihalaymiz, ombordan yetkazamiz va oʻrnatamiz. Yuk koʻtarish 4 tonnagacha · shartnoma boʻyicha 10 yil kafolat.',
    cta1: 'Omborim sigʻimini bilish', cta2: 'Katalogni koʻrish',
    chips: ['Bepul oʻlchov va loyiha', 'Kuniga 300 m² gacha kalit topshirish', 'Boʻlib toʻlash va lizing'],
