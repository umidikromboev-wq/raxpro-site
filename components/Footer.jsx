  ...
  return (
    <footer className="bg-navy-900 text-cloud-200">
      <div className="w-full px-5 sm:px-8 lg:px-14 2xl:px-24 py-14 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-1">
          ...
          <p className="mt-4 text-sm text-cloud-200/70 leading-relaxed">
            Стеллажи и системы хранения полного цикла. Замер, проектирование, производство и монтаж по всему Узбекистану.
          </p>
      ...
      <div className="border-t border-white/10">
        <div className="w-full px-5 sm:px-8 lg:px-14 2xl:px-24 py-5 flex flex-col sm:flex-row justify-between gap-2 text-xs text-cloud-200/50">
          <p>© {year} RAXPRO. Все права защищены.</p>
