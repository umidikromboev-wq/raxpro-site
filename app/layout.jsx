...
export const metadata = {
  ...
  description:
    'RAXPRO — производство и монтаж стеллажей в Ташкенте: паллетные, среднегрузовые, архивные, торговые. Нагрузка до 4 т, официальная гарантия 10 лет, бесплатный замер и расчёт за 24 часа. 1000+ проектов по Узбекистану.',
  keywords:
