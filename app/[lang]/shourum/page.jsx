...
const T = {
  ...
  uz: {
    ...
    lead: "Buyurtmadan oldin stellajlarni oʻz koʻzingiz bilan koʻrish uchun keling: metall, boʻyoq, balka qulflari. Menejer savollaringizga javob beradi va hisob-kitobda yordam beradi.",
    route: "Marshrut tuzish",
    ...
    seoTitle: "Toshkentdagi RAXPRO shourumi — stellajlarni oʻz koʻzingiz bilan koʻring | Toʻrt Ariq, 11/1",
