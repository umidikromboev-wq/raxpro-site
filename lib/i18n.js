...
export const T = {
  ru: {
    ...
    stats: [
      ...
      { n: "10", s: "лет", l: "официальной гарантии по договору" },
    ...
    revText:
      "Видеоинтервью, переписки и голосовые сообщения клиентов — дословно, с фото их объектов.",
    specialists: [
      {
        id: 1,
  ...
  uz: {
    ...
    stats: [
      ...
      { n: "10", s: "yil", l: "shartnoma boʻyicha rasmiy kafolat" },
    ...
    revText:
      "Mijozlarning videointervyulari, yozishmalari va ovozli xabarlari — soʻzma-soʻz, obyekt suratlari bilan.",
  },
};
...
export const EXTRA = {
  ru: {
    ...
    afterSteps: [
      { time: "5 минут", t: "Ответим", d: "Уточним задачу и ответим на вопросы. В Telegram или по телефону — как удобнее." },
      { time: "Сразу", t: "Предварительный расчёт", d: "Раскладка и цена по прайсу — в конструкторе на сайте или от менеджера по вашим размерам." },
      { time: "24 часа", t: "Выезд замерщика", d: "Проверим пол, колонны, ворота и нагрузку. По Ташкенту — бесплатно." },
      { time: "После замера", t: "Проект и точная цена", d: "План расстановки, 3D-модель, спецификация и КП с ценой. Ссылка открывается без регистрации." },
      { time: "Решение за вами", t: "Договор и монтаж", d: "Никакой предоплаты за расчёт. Подписали — производим и монтируем." },
    ],
    afterHandsTitle: "Что получаете на руки",
    afterHands: ["План расстановки", "3D-модель склада", "Спецификацию с количеством", "КП с ценой и сроком", "Гарантию 10 лет по договору"],
    faqEyebrow: "Вопросы",
    ...
    faq: [
      ...
      {
        q: "Есть ли гарантия?",
        a: "Да — 10 лет официальной гарантии по договору. На рынке Узбекистана это даём только мы.",
      },
      {
    ...
    cmpRows: [
      ...
      {
        us: "10 лет гарантии по договору",
  ...
  uz: {
    ...
    afterSteps: [
      { time: "5 daqiqa", t: "Javob beramiz", d: "Vazifani aniqlaymiz va savollarga javob beramiz. Telegram yoki telefon — qaysi qulay boʻlsa." },
      { time: "Darhol", t: "Dastlabki hisob", d: "Joylashuv va narxnoma boʻyicha narx — saytdagi konstruktorda yoki menejerdan oʻlchamlaringiz boʻyicha." },
      { time: "24 soat", t: "Oʻlchovchi chiqadi", d: "Pol, ustunlar, darvoza va yuklamani tekshiramiz. Toshkent boʻylab — bepul." },
      { time: "Oʻlchovdan soʻng", t: "Loyiha va aniq narx", d: "Joylashuv rejasi, 3D model, spetsifikatsiya va narxli taklif. Havola roʻyxatdan oʻtmasdan ochiladi." },
      { time: "Qaror sizniki", t: "Shartnoma va montaj", d: "Hisob-kitob uchun oldindan toʻlov yoʻq. Imzoladik — ishlab chiqaramiz va oʻrnatamiz." },
    ],
    afterHandsTitle: "Qoʻlingizga nima olasiz",
    afterHands: ["Joylashuv rejasi", "Ombor 3D modeli", "Miqdorli spetsifikatsiya", "Narx va muddatli taklif", "Shartnoma boʻyicha 10 yil kafolat"],
    faqEyebrow: "Savollar",
    ...
    faq: [
      ...
      {
        q: "Kafolat bormi?",
        a: "Ha — shartnoma boʻyicha 10 yil rasmiy kafolat. Oʻzbekiston bozorida buni faqat biz beramiz.",
      },
      {
    ...
    cmpRows: [
      ...
      { us: "Shartnoma boʻyicha 10 yil kafolat", them: "Kafolat faqat «ogʻzaki»" },
      {
