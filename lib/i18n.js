...
export const T = {
  ru: {
    ...
    specialists: [
      { id: 1, name: "Хуршидбек Косимов", img: "/works/expert1.PNG" },
      { id: 2, name: "Исломбек Эркинов", img: "/works/expert2.jpg" },
      { id: 3, name: "Нурилла Убайдуллаев", img: "/works/expert4.jpg" },
      { id: 3, name: "Муродбек Тохиров", img: "/works/expert5.png" },
      { id: 4, name: "Шахзода Ганиходжаева", img: "/works/expert3.jpg" },
    ],
  },
  ...
  uz: {
    ...
    teamText:
      "Ko'p yillik tajriba va chuqur bilimga ega mutaxassislarimiz sizning ehtiyojlaringizni tahlil qilib, eng maqbul va samarali yechimlarni taklif etadi.",
    specialists: [
      { id: 1, name: "Xurshidbek Qosimov", img: "/works/expert1.PNG" },
      { id: 2, name: "Islombek Erkinov", img: "/works/expert2.jpg" },
      { id: 3, name: "Nurilla Ubaydullayev", img: "/works/expert4.jpg" },
      { id: 3, name: "Murodbek Tohirov", img: "/works/expert5.png" },
      { id: 4, name: "Shaxzoda G'anixo'jayeva", img: "/works/expert3.jpg" },
    ],
