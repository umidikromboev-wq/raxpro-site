...
export const T = {
  ru: {
    ...
    heroPrice: "Проекты от 1,2 млн сум · план и точная цена в день замера",
  ...
  uz: {
    ...
    heroPrice: "Loyihalar 1,2 mln soʻmdan · reja va aniq narx oʻlchov kuni",
    ...
    faq: [
      {
        ...
        a: "Цена зависит от типа, нагрузки и размеров. Замер бесплатный, а план, 3D-модель и КП с точной ценой отдаём в день замера. Минимальный заказ — от 1,2 млн сум, доступна рассрочка Uzum Nasiya.",
      },
      {
    ...
    faq: [
      {
        ...
        a: "Narx turi, yuklama va oʻlchamlarga bogʻliq. Oʻlchov bepul, reja, 3D model va aniq narxli tijorat taklifini oʻlchov kunining oʻzida beramiz. Minimal buyurtma — 1,2 mln soʻmdan, Uzum Nasiya boʻlib toʻlash mavjud.",
      },
      {
