...
export const T = {
  ru: {
    ...
    trustStats: [
      ...
      { n: "7", s: "дней", l: "от замера до сдачи под ключ" },
  ...
  uz: {
    ...
    trustStats: [
      ...
      { n: "7", s: "kun", l: "oʻlchovdan kalit topshirishgacha" },
  ...
  ru: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Всё в наличии: 150 тонн стеллажей на складе в Ташкенте. По Ташкенту привезём завтра, по регионам — до 7 дней. Склад под ключ, вместе с замером, проектом и монтажом — за 7 дней.",
      },
      {
  ...
  uz: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Hammasi mavjud: Toshkent omborida 150 tonna stellaj. Toshkent boʻyicha ertaga yetkazamiz, viloyatlarga — 7 kungacha. Oʻlchov, loyiha va montaj bilan kalit topshirish — 7 kunda.",
      },
      {
