...
export const EXTRA = {
  ru: {
    ...
    afterSteps: [
      { time: "5 мин", d: "ответим в Telegram или по телефону — в рабочее время, Пн–Сб 9:00–18:00" },
  ...
  uz: {
    ...
    afterSteps: [
      { time: "5 daqiqa", d: "Telegram yoki telefon orqali javob beramiz — ish vaqtida, Du–Sha 9:00–18:00" },
