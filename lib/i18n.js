...
export const EXTRA = {
  ru: {
    ...
    afterHands: ["План расстановки", "3D-модель склада", "Спецификацию с количеством", "КП с ценой и сроком", "Гарантию 10 лет по документу"],
    faqEyebrow: "Вопросы",
  ...
  uz: {
    ...
    afterHands: ["Joylashuv rejasi", "Ombor 3D modeli", "Miqdorli spetsifikatsiya", "Narx va muddatli taklif", "Hujjat asosida 10 yil kafolat"],
    faqEyebrow: "Savollar",
