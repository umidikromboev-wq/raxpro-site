...
export const T = {
  ru: {
    ...
    heroPrice: "Цена от 800 000 сум · план и точная цена в день замера",
    ...
    calcText:
      "Ответьте на 4 вопроса — менеджер подготовит точный расчёт и коммерческое предложение. Замер бесплатно, план и цена — в день замера, отвечаем в течение 5 минут.",
    ...
    trustText: "Каждый квадратный метр в работе: наши клиенты используют даже пространство под потолком — от маркетплейсов до заводов.",
    trustStats: [
      { n: "1000+", s: "", l: "складов оборудовано" },
      { n: "50 000+", s: "", l: "паллетомест смонтировано" }, // PLACEHOLDER
      { n: "5", s: "дней", l: "от замера до сдачи под ключ" },
      { n: "4,9", s: "★", l: "Google · 120 отзывов" },
    ...
    adv: [
      ...
      {
        t: "150 тонн на складе в Ташкенте",
        d: "Всё в наличии: от 1 секции до проектов на несколько миллиардов сум. Со склада — привезём завтра.",
      },
      {
      ...
      },
      {
        ...
        d: "Замер, проектирование, комплектация со склада, доставка и монтаж. По Ташкенту замер, доставка и монтаж бесплатны.",
      },
      {
        t: "Расчёт в день замера",
        d: "Выезжаем, замеряем, проектируем и отдаём план, 3D-модель и КП с точной ценой — бесплатно и без обязательств.",
      },
    ],

    founderEyebrow: "Основатель",
    founderName: "Хуршидбек Касимов",
    ...
    certsLabel: "Завод-партнёр, который выпускает наши стеллажи, сертифицирован по ISO 9001, 14001 и 45001",
    ...
    formText:
      "Замер за 24 часа. План, 3D-модель и КП с точной ценой — в день замера.",
    ...
    specialists: [
      {
        ...
        img: "/images/team/xurshidbek-real.jpg",
      },
      {
        id: 2,
        ...
        img: "/images/team/islombek-real.jpg",
      },
      {
        id: 3,
        ...
        img: "/images/team/nurilla-real.jpg",
      },
      {
        id: 4,
        ...
        img: "/images/team/murodbek-real.jpg",
      },
      {
        id: 5,
        ...
        img: "/images/team/shaxzoda-real.jpg",
      },
    ],
  },
  ...
  uz: {
    ...
    thankYouDesc:
      "Bizga ishonch bildirganingiz uchun rahmat. Mutaxassislarimiz tez orada siz bilan bogʻlanishadi va barcha savollaringizga javob berishadi.",
    backToHome: "Bosh sahifaga qaytish",
    haveQuestions: "Shoshilinch savollar bormi?",
    callUs: "Bizga qoʻngʻiroq qiling",
    teamTitle: "Bizning Mutaxassislarimiz",
    teamText:
      "Koʻp yillik tajriba va chuqur bilimga ega mutaxassislarimiz sizning ehtiyojlaringizni tahlil qilib, eng maqbul va samarali yechimlarni taklif etadi.",
    specialists: [
      {
        id: 1,
      ...
      },
      {
        ...
        role: "Marketing boʻlimi rahbari (CMO)",
        specialties: [
      ...
      {
        id: 5,
        name: "Shaxzoda Gʻanixoʻjayeva",
        role: "Sotuv boʻlimi rahbari (CSO)",
        specialties: [
    ...
    heroPrice: "Narx 800 000 soʻmdan boshlanadi · reja va aniq narx oʻlchov kuni",
    ...
    calcText:
      "4 ta savolga javob bering — menejer aniq hisob-kitob va tijorat taklifini tayyorlaydi. Oʻlchov bepul, reja va narx — oʻlchov kuni, 5 daqiqada javob beramiz.",
    ...
    trustText: "Har bir kv m dan foydalanib, mijozlarimiz hatto havodan ham foydalanishmoqda — marketpleyslardan zavodlargacha.",
    trustStats: [
      { n: "1000+", s: "", l: "ombor jihozlangan" },
      { n: "50 000+", s: "", l: "palleta oʻrni oʻrnatilgan" }, // PLACEHOLDER
      { n: "5", s: "kun", l: "oʻlchovdan kalit topshirishgacha" },
      { n: "4,9", s: "★", l: "Google · 120 ta sharh" },
    ...
    adv: [
      ...
      {
        t: "Toshkent omborida 150 tonna",
        d: "Hammasi mavjud: 1 seksiyadan bir necha milliard soʻmlik loyihalargacha. Ombordan — ertaga yetkazamiz.",
      },
      {
      ...
      },
      {
        ...
        d: "Oʻlchov, loyiha, ombordan butlash, yetkazish va montaj. Toshkent boʻyicha oʻlchov, yetkazish va montaj bepul.",
      },
      {
        t: "Oʻlchov kunida hisob-kitob",
        d: "Chiqamiz, oʻlchaymiz, loyihalaymiz va narxni hisoblaymiz — bepul va majburiyatsiz.",
      },
    ],

    founderEyebrow: "Asoschi",
    founderName: "Xurshidbek Qosimov",
    ...
    certsLabel: "Stellajlarimizni ishlab chiqaruvchi hamkor zavod ISO 9001, 14001 va 45001 boʻyicha sertifikatlangan",
    ...
    formText:
      "Oʻlchov 24 soatda. Reja, 3D model va aniq narxli tijorat taklifi — oʻlchov kunining oʻzida.",
...
export const BLOG_UI = {
  ru: {
    ...
    needCalcText:
      "Бесплатный замер, а план, 3D-модель и цена — в день замера. Оставьте заявку — свяжемся с вами.",
  ...
  uz: {
    ...
    needCalcText:
      "Oʻlchov bepul, reja, 3D model va narx — oʻlchov kunining oʻzida. Ariza qoldiring — siz bilan bogʻlanamiz.",
...
export const EXTRA = {
  ru: {
    ...
    afterSteps: [
      ...
      { time: "в день замера", d: "план, 3D-модель и КП с точной ценой" },
    ],
    ...
    faq: [
      {
        ...
        a: "Цена зависит от типа, нагрузки и размеров. Замер бесплатный, а план, 3D-модель и КП с точной ценой отдаём в день замера. Цена — от 800 000 сум, доступна рассрочка Uzum Nasiya.",
      },
      {
      ...
      },
      {
        ...
        a: "Да, полный цикл «под ключ»: замер, проектирование, комплектация со склада, доставка и монтаж. По Ташкенту замер, доставка и монтаж бесплатны, по регионам — по объёму проекта.",
      },
      {
      ...
      },
      {
        ...
        a: "Всё в наличии: 150 тонн стеллажей на складе в Ташкенте. По Ташкенту привезём завтра, по регионам — до 7 дней. Склад под ключ, вместе с замером, проектом и монтажом — за 5 дней.",
      },
      {
  ...
  uz: {
    ...
    afterSteps: [
      ...
      { time: "oʻlchov kuni", d: "reja, 3D model va aniq narxli tijorat taklifi" },
    ],
    ...
    faq: [
      {
        ...
        a: "Narx turi, yuklama va oʻlchamlarga bogʻliq. Oʻlchov bepul, reja, 3D model va aniq narxli tijorat taklifini oʻlchov kunining oʻzida beramiz. Narx 800 000 soʻmdan boshlanadi, Uzum Nasiya boʻlib toʻlash mavjud.",
      },
      {
      ...
      },
      {
        ...
        a: "Ha, toʻliq sikl «kalit topshirish»: oʻlchov, loyihalash, ombordan butlash, yetkazish va montaj. Toshkent boʻyicha oʻlchov, yetkazish va montaj bepul, viloyatlarda — loyiha hajmiga qarab.",
      },
      {
      ...
      },
      {
        ...
        a: "Hammasi mavjud: Toshkent omborida 150 tonna stellaj. Toshkent boʻyicha ertaga yetkazamiz, viloyatlarga — 7 kungacha. Oʻlchov, loyiha va montaj bilan kalit topshirish — 5 kunda.",
      },
      {
