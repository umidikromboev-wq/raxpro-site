...
export const POLICIES = {
  'dostavka-i-oplata': {
    ru: {
      ...
      seoDesc:
        'Условия доставки стеллажей RAXPRO: по Ташкенту бесплатно и на следующий день, по регионам Узбекистана — до 7 рабочих дней. Монтаж по Ташкенту бесплатно. Оплата перечислением, наличными, в рассрочку и лизинг.',
      lead: 'Комплектуем со своего склада в Ташкенте — 150 тонн в наличии, — привозим и собираем сами, без посредников. Ниже точные сроки, зоны и способы оплаты.',
      blocks: [
        {
          h: 'Сроки поставки',
          items: [
            'Всё в наличии: 150 тонн стеллажей на складе в Ташкенте. По Ташкенту привозим на следующий рабочий день после подтверждения заказа.',
            'Регионы Узбекистана — до 7 рабочих дней с момента подтверждения заказа.',
            'Склад под ключ — 5 дней: замер и проект в один день, комплектация, доставка и монтаж.',
          ],
        },
        {
          ...
          items: [
            ...
            'Монтаж по Ташкенту — бесплатно, силами наших монтажников. По регионам монтаж и разгрузку считаем по объёму проекта и называем до оплаты счёта.',
          ],
        },
        {
          h: 'Способы оплаты',
        ...
        },
        {
          ...
          text: 'Минимальная сумма заказа — 800 000 сум. Замер, расчёт нагрузок и проект стеллажной системы выполняем бесплатно и до оплаты.',
        },
        {
          ...
          items: [
            ...
            'Комплектуем заказ со склада и сообщаем дату доставки.',
    ...
    uz: {
      ...
      seoDesc:
        'RAXPRO stellajlarini yetkazib berish shartlari: Toshkent boʻylab bepul va ertasiga, viloyatlarga — 7 ish kunigacha. Toshkent boʻyicha montaj bepul. Toʻlov pul oʻtkazma, naqd, boʻlib toʻlash va lizing orqali.',
      lead: 'Toshkentdagi oʻz omborimizdan butlaymiz — 150 tonna mavjud, — oʻzimiz yetkazamiz va yigʻamiz, vositachisiz. Quyida aniq muddatlar, hududlar va toʻlov usullari.',
      blocks: [
        {
          h: 'Yetkazish muddatlari',
          items: [
            'Hammasi mavjud: Toshkent omborida 150 tonna stellaj. Toshkent boʻyicha buyurtma tasdiqlangandan keyingi ish kuni yetkazamiz.',
            'Oʻzbekiston viloyatlari — buyurtma tasdiqlangandan soʻng 7 ish kunigacha.',
        ...
        },
        {
          ...
          items: [
            ...
            'Toshkent boʻyicha montaj bepul — oʻz montajchilarimiz. Viloyatlarda montaj va tushirish loyiha hajmiga qarab hisoblanadi va hisob toʻlanishidan oldin aytiladi.',
          ],
        },
        {
          h: 'Toʻlov usullari',
        ...
        },
        {
          ...
          text: 'Buyurtmaning eng kam summasi — 800 000 soʻm. Oʻlchov, yuklama hisobi va stellaj tizimi loyihasini bepul hamda toʻlovdan oldin bajaramiz.',
        },
        {
          ...
          items: [
            ...
            'Buyurtmani ombordan butlaymiz va yetkazish sanasini xabar qilamiz.',
    ...
    uz: {
      ...
      blocks: [
        ...
        },
        {
          h: 'Nuqson aniqlansa',
          items: [
            'Barcha mahsulotga shartnoma bilan rasmiylashtirilgan 10 yillik kafolat amal qiladi.',
  ...
  'publichnaya-oferta': {
    ru: {
      ...
      blocks: [
        {
          h: '1. Предмет',
          text: 'Продавец — компания RAXPRO, поставщик металлических стеллажей и систем хранения (г. Ташкент). Продавец обязуется передать Покупателю продукцию, представленную в каталоге сайта, а Покупатель — принять её и оплатить на условиях настоящей оферты.',
        },
        {
          h: '2. Оформление заказа',
          items: [
            'Заказ оформляется через корзину на сайте, по телефону, в Telegram или WhatsApp.',
            'После оформления менеджер связывается с Покупателем и подтверждает состав заказа, стоимость, срок поставки и адрес доставки.',
        ...
        {
          h: '5. Гарантия',
          text: 'На поставляемую продукцию предоставляется гарантия 10 лет, оформленная гарантийным документом. Гарантия покрывает производственные дефекты при соблюдении заявленных нагрузок и правил эксплуатации.',
        },
        {
          h: '6. Возврат и обмен',
    ...
    uz: {
      ...
      blocks: [
        {
          h: '1. Predmet',
          text: 'Sotuvchi — RAXPRO kompaniyasi, metall stellajlar va saqlash tizimlari taʼminotchisi (Toshkent sh.). Sotuvchi sayt katalogida taqdim etilgan mahsulotni Xaridorga topshirish, Xaridor esa uni qabul qilib, ushbu oferta shartlari asosida toʻlash majburiyatini oladi.',
        },
        {
        ...
        {
          h: '5. Kafolat',
          text: 'Yetkazib beriladigan mahsulotga kafolat hujjati bilan rasmiylashtirilgan 10 yillik kafolat beriladi. Kafolat eʼlon qilingan yuklamalar va foydalanish qoidalariga rioya qilinganda ishlab chiqarish nuqsonlarini qoplaydi.',
        },
        {
      ...
      blocks: [
        {
          ...
          text: 'Оператор — компания RAXPRO, поставщик металлических стеллажей и систем хранения, г. Ташкент. Контактные данные и адрес указаны на странице «Контакты». Обработка ведётся в соответствии с Законом Республики Узбекистан «О персональных данных» № ЗРУ-547.',
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            'Скомплектовать, доставить и смонтировать заказ, выставить счёт и оформить документы.',
        ...
        },
        {
          ...
          text: 'Заявки и заказы хранятся, пока действует гарантия на поставленную продукцию (10 лет) и пока это нужно для бухгалтерского учёта. Если сделка не состоялась, заявка хранится не дольше трёх лет. По вашему запросу данные удаляются раньше.',
        },
        {
      ...
      blocks: [
        {
          ...
          text: 'Operator — metall stellajlar va saqlash tizimlari taʼminotchisi RAXPRO kompaniyasi, Toshkent shahri. Aloqa maʼlumotlari va manzil «Aloqa» sahifasida koʻrsatilgan. Qayta ishlash Oʻzbekiston Respublikasining «Shaxsga doir maʼlumotlar toʻgʻrisida»gi OʻRQ-547-son qonuniga muvofiq olib boriladi.',
        },
        {
