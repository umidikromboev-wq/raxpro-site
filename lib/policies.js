...
export const POLICIES = {
  'dostavka-i-oplata': {
    ru: {
      ...
      seoDesc:
        'Условия доставки стеллажей RAXPRO: по Ташкенту бесплатно, отгрузка со склада 1–2 рабочих дня, доставка по регионам Узбекистана. Оплата перечислением, наличными, в рассрочку и лизинг.',
      lead: 'Комплектуем со своего склада, привозим и собираем сами — без посредников. Ниже точные сроки, зоны и способы оплаты.',
      blocks: [
        {
          h: 'Сроки поставки',
          items: [
            'Типовые позиции из каталога — в наличии на складе в Ташкенте, отгрузка 1–2 рабочих дня с момента подтверждения заказа.',
    ...
    uz: {
      ...
      seoDesc:
        'RAXPRO stellajlarini yetkazib berish shartlari: Toshkent boʻylab bepul, ombordan joʻnatish 1–2 ish kuni, viloyatlarga yetkazish. Toʻlov pul oʻtkazma, naqd, boʻlib toʻlash va lizing orqali.',
      lead: 'Oʻz omborimizdan butlaymiz, oʻzimiz yetkazamiz va yigʻamiz — vositachisiz. Quyida aniq muddatlar, hududlar va toʻlov usullari.',
      blocks: [
        {
          h: 'Yetkazish muddatlari',
          items: [
            'Katalogdagi tipovoy pozitsiyalar — Toshkentdagi omborda mavjud, buyurtma tasdiqlangandan soʻng 1–2 ish kunida joʻnatiladi.',
