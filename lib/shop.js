...
export const SHOP = {
  ru: {
    ...
    catalogSeoDesc:
      'Металлические стеллажи RAXPRO: паллетные, набивные drive-in, среднегрузовые, архивные, торговые и мезонины. Типовые секции с ценами, остальное — по проекту. Всё в наличии на складе, гарантия 10 лет.',
    ...
    deliveryShort:
      'По Ташкенту бесплатно, отгрузка со склада 1–2 рабочих дня. Оплата перечислением, наличными или в рассрочку.',
    ...
    madeDays: 'Отгрузка со склада: 1–2 рабочих дня',
