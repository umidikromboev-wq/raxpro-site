...
export const SHOP = {
  ru: {
    ...
    catalogLead:
      'Шесть видов стеллажей в наличии на складе в Ташкенте. Типовые секции — с точной ценой, размерами и нагрузкой; набивные, торговые и мезонины считаем по проекту под ваше помещение в день замера.',
    ...
    byProjectNote: 'Считаем по замеру: размеры, нагрузка, планировка помещения. План и цена — в день замера.',
    ...
    otherSizeText:
      'Подберём секцию под ваши габариты и нагрузку. Замер бесплатно, план и цена — в день замера.',
  ...
  uz: {
    ...
    catalogLead:
      'Toshkentdagi omborimizda mavjud olti xil stellaj. Tipovoy seksiyalar — aniq narxi, oʻlchamlari va yuklamasi bilan; zich, savdo stellajlari va mezoninlarni xonangizga moslab oʻlchov kuni loyiha boʻyicha hisoblaymiz.',
    ...
    byProjectNote: 'Oʻlchovdan keyin hisoblaymiz: oʻlchamlar, yuklama, xona tartibi. Reja va narx — oʻlchov kuni.',
    ...
    otherSizeText:
      'Seksiyani sizning gabarit va yuklamangizga moslab tayyorlaymiz. Oʻlchov bepul, reja va narx — oʻlchov kuni.',
