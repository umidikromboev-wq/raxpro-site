...
export const SHOP = {
  ru: {
    ...
    catalogLead:
      'Шесть видов стеллажей собственного производства. Типовые секции — с точной ценой, размерами и нагрузкой; набивные, торговые и мезонины считаем по проекту под ваше помещение за 24 часа.',
    catalogSeoTitle: 'Каталог стеллажей в Ташкенте — цены от производителя | RAXPRO',
    catalogSeoDesc:
      'Металлические стеллажи RAXPRO: паллетные, набивные drive-in, среднегрузовые, архивные, торговые и мезонины. Типовые секции с ценами, остальное — по проекту. Собственное производство, гарантия 10 лет.',
  ...
  uz: {
    ...
    catalogLead:
      'Oʻz ishlab chiqarishimizdagi olti xil stellaj. Tipovoy seksiyalar — aniq narxi, oʻlchamlari va yuklamasi bilan; zich, savdo stellajlari va mezoninlarni xonangizga moslab 24 soatda loyiha boʻyicha hisoblaymiz.',
    catalogSeoTitle: 'Toshkentda stellajlar katalogi — ishlab chiqaruvchi narxlari | RAXPRO',
    catalogSeoDesc:
      'RAXPRO metall stellajlari: palletli, zich drive-in, oʻrta yuklamali, arxiv, savdo stellajlari va mezoninlar. Tipovoy seksiyalar narxi bilan, qolgani — loyiha boʻyicha. Oʻz ishlab chiqarishimiz, 10 yil kafolat.',
