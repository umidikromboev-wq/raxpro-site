...
export const USE_LANDINGS = [
  use("na-sklad", {
    type: "pallet", cover: "/directions/pallet.jpg", caseKeys: ["avtozapchast", "mirvali", "caffelito"], reviewIds: ["sobirjon", "muhriddin", "nurbek"], productSlugs: [PALLET, MEDIUM],
    ru: {
    ...
    uz: {
      ...
      lead: "Palletli — pogruzchik uchun, oʻrta yuklamali — qutilarni qoʻlda terish uchun. Turini tovar va texnikaga qarab tanlaymiz, aksincha emas.",
      points: [
        { t: "Tovarga mos tur", d: "Palletlar va pogruzchik — har yarusga 1000 kg gacha palletli. Qutilar va dona tovar — har yarusga 300–400 kg oʻrta yuklamali." },
        { t: "Ombor balandligi ishlaydi", d: "Shiftgacha yaruslar: avto ehtiyot qismlar omborida sigʻim 120 dan 460 palletga oshdi." },
        { t: "Texnika uchun yoʻlaklar", d: "Yoʻlaklar kengligini montajdan oldin pogruzchik yoki aravachangizga qarab hisoblaymiz." },
        { t: "Seksiyalab qoʻshish", d: "Tovar zaxirasi oʻsganda qatorlar seksiyalar bilan uzaytiriladi." },
      ],
      faq: [{ q: "Ombor uchun qaysi stellajni tanlash kerak?", a: "Tovar palletda boʻlsa va pogruzchik bor boʻlsa — palletli. Qutilar qoʻlda olinsa — oʻrta yuklamali. Oʻlchovda aralash variantni tanlab beramiz." }],
  ...
  use("dlya-pvz", {
    type: "medium", cover: "/cases/bloom-1.jpg", caseKeys: ["bloom"], reviewIds: ["rastalar", "vitrina", "nurbek"], productSlugs: [MEDIUM, ARCHIVE],
    ru: {
    ...
    uz: {
      ...
      lead: "Topshirish punkti posilkani tez topishga bogʻliq: raqamli yacheykalar, erkin yoʻlak, turli oʻlchamdagi qutilar uchun polkalar.",
      points: [
        { t: "Manzilli saqlash yacheykalari", d: "Har bir seksiya va polka raqam oladi — posilka xotiradan emas, manzil boʻyicha topiladi." },
      ...
      seoDesc: "Buyurtmalarni topshirish punkti uchun stellajlar: manzilli yacheykalar, 300–400 kg polkalar, 1500/2000 mm seksiyalar. Bepul oʻlchov, montaj, 10 yil kafolat.",
    },
  }),
  use("dlya-korobok", {
    type: "medium", cover: "/directions/medium.jpg", caseKeys: ["bloom", "cold", "caffelito"], reviewIds: ["muhriddin", "sobirjon", "rastalar"], productSlugs: [MEDIUM],
    ru: {
  ...
  use("dlya-dokumentov", {
    type: "archive", cover: "/directions/archive.jpg", caseKeys: ["discovery"], reviewIds: ["prilavok", "vitrina", "nurbek"], productSlugs: [ARCHIVE],
    ru: {
    ...
    uz: {
      ...
      seoDesc: "Hujjatlar uchun arxiv stellajlari 2000×1000×400 mm, 3–6 polka, 1 000 000 soʻmdan. Papkalar va arxiv qutilari uchun. Toshkent boʻylab yetkazish, 10 yil kafolat.",
    },
  }),
  use("dlya-ofisa", {
    type: "archive", cover: "/products/gen/archive-1.jpg", caseKeys: ["discovery"], reviewIds: ["prilavok", "nurbek", "vitrina"], productSlugs: [ARCHIVE, MEDIUM],
    ru: {
  ...
  use("dlya-podsobki", {
    type: "medium", cover: "/cases/sayqal-2.jpg", caseKeys: ["sayqal", "xonadon", "elite"], reviewIds: ["muhriddin", "nurbek", "salohiddin"], productSlugs: [MEDIUM, ARCHIVE],
    ru: {
  ...
  use("hozyajstvennye", {
    type: "medium", cover: "/cases/xonadon-1.jpg", caseKeys: ["xonadon", "sayqal"], reviewIds: ["xonadon", "salohiddin", "muhriddin", "nurbek"], productSlugs: [MEDIUM, ARCHIVE],
    ru: {
  ...
  use("dlya-bibliotek", {
    type: "archive", cover: "/products/gen/archive-2.jpg", caseKeys: ["discovery"], reviewIds: ["prilavok", "vitrina", "nurbek"], productSlugs: [ARCHIVE],
    ru: {
  ...
  use("dlya-shin", {
    type: "medium", cover: "/cases/avtozapchast-1.jpg", caseKeys: ["avtozapchast", "jac"], reviewIds: ["avtoservis", "sobirjon", "muhriddin"], productSlugs: [MEDIUM, PALLET],
    ru: {
  ...
  use("dlya-sto", {
    type: "medium", cover: "/cases/jac-2.jpg", caseKeys: ["avtozapchast", "jac"], reviewIds: ["avtoservis", "sobirjon", "muhriddin"], productSlugs: [MEDIUM],
    ru: {
  ...
  use("dlya-garazha", {
    type: "medium", cover: "/cases/xonadon-2.jpg", caseKeys: ["xonadon"], reviewIds: ["avtoservis", "salohiddin", "nurbek"], productSlugs: [MEDIUM, ARCHIVE],
    ru: {
    ...
    uz: {
      ...
      seoDesc: "Garaj uchun metall stellajlar: gʻildiraklar, asboblar, kanistrlar. Har yarusga 300–400 kg, kukunli boʻyoq, 10 yil kafolat. Toshkent boʻylab yetkazish.",
    },
  }),
];
