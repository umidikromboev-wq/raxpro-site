...
export const PRODUCT_MENU = {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          ["Для дисков", "/stellazhi/dlya-diskov"],
          ["Для кладовки", "/stellazhi/dlya-kladovki"],
          ["В подвал", "/stellazhi/v-podval"],
          ["На балкон", "/stellazhi/na-balkon"],
          ["Для банок", "/stellazhi/dlya-banok"],
          ["Для книг", "/stellazhi/dlya-knig"],
          ["Для одежды", "/stellazhi/dlya-odezhdy"],
        ],
      },
    ],
  },
  uz: {
    ...
    groups: [
      ...
      {
        title: "Savdo stellajlari: doʻkon turi boʻyicha",
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          ["Disklar uchun", "/stellazhi/dlya-diskov"],
          ["Kladovka uchun", "/stellazhi/dlya-kladovki"],
          ["Yertoʻlaga", "/stellazhi/v-podval"],
          ["Balkonga", "/stellazhi/na-balkon"],
          ["Bankalar uchun", "/stellazhi/dlya-banok"],
          ["Kitoblar uchun", "/stellazhi/dlya-knig"],
          ["Kiyimlar uchun", "/stellazhi/dlya-odezhdy"],
        ],
      },
    ],
  },
