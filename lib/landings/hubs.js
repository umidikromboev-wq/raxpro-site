...
export const HUBS = {
  uslugi: {
    ...
    uz: {
      ...
      lead: "Toʻliq sikl bilan ishlaymiz: oʻlchov, joylashtirish loyihasi, Toshkentdagi ombordan komplektatsiya, yetkazib berish va montaj. Toshkent boʻylab oʻlchov, yetkazib berish va montaj bepul.",
      seoTitle: "RAXPRO xizmatlari — oʻlchov, loyiha, yetkazib berish va montaj",
      ...
      items: [
        ...
        { t: "Shourum", d: "Buyurtmadan oldin metall, boʻyoq va qulflarni oʻz koʻzingiz bilan koʻring.", path: "/shourum" },
      ],
    },
  },
  pokupatelyam: {
    ...
    uz: {
      ...
      seoDesc: "RAXPRO xaridorlari uchun maʼlumot: shartnoma boʻyicha 10 yil kafolat, Toshkent boʻylab bepul yetkazib berish, toʻlov, qaytarish va almashtirish, ommaviy oferta.",
