...
export const RETAIL_LANDINGS = [
  ...
  base("kosmetika", {
    ...
    uz: {
      ...
      points: [
        { t: "Polkalar oraligʻi kichik", d: "Xuddi shu balandlikda koʻproq yarus — flakon va tyubiklar bir qatorda turadi, ichkarida yoʻqolib ketmaydi." },
  ...
  base("magazin-elektroniki", {
    ...
    uz: {
      ...
      points: [
        ...
        { t: "Qutilar koʻrinmaydi", d: "Pastki yaruslar va doʻkon qoshidagi ombor qadoqlarni saqlaydi, zal toza qoladi." },
  ...
  base("bytovaya-tehnika", {
    ...
    uz: {
      ...
      faq: [
        ...
        { q: "Narxi koʻrsatilgan tayyor oʻlchamlar bormi?", a: "Ha, 2000×2000×600 oʻrta yuklamali stellaj katalogda narxi bilan bor. Qolgani — loyiha boʻyicha." },
  ...
  base("gipermarket", {
    ...
    uz: {
      ...
      points: [
        { t: "Uch zona — bitta pudratchi", d: "Zal, ombor va orqa xonalarni birga loyihalaymiz: yoʻlaklar, yuklagich va tovar oqimi rejada mos keladi." },
        { t: "Omborda palletlar", d: "Har yarusga 1000 kg gacha palletli stellajlar, har bir joyga yuklagich bilan kirish." },
  ...
  base("minimarket", {
    ...
    uz: {
      ...
      short: "Minimarket",
      lead: "Kichik maydonda balandlik yutadi: shiftgacha devoriy stellajlar, oʻrtada tor orol stellajlar va yuqori yaruslarda zaxira. Montaj — doʻkonni uzoq yopmasdan.",
      points: [
        ...
        { t: "Tez montaj", d: "Seksiyalar joyida yigʻiladi; reja va narx — bepul oʻlchov kuni." },
      ...
      faq: [
        ...
        { q: "Doʻkonni bir kunga yopsa boʻladimi?", a: "Kichik zalda montaj odatda qisqa muddatda bajariladi; aniq sana va davomiylik shartnomada kelishiladi." },
