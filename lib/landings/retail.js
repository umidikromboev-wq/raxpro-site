...
export const RETAIL_LANDINGS = [
  ...
  base("apteka", {
    cover: "/products/gen/retail-2.jpg",
    caseKeys: ["bloom"],
    ...
    ru: {
      ...
      seoTitle: "Стеллажи для аптеки в Ташкенте — за прилавок и в зал | RAXPRO",
    ...
    uz: {
      ...
      seoTitle: "Dorixona uchun stellajlar Toshkentda — peshtaxta orti va zal | RAXPRO",
  ...
  base("magazin-elektroniki", {
    cover: "/products/gen/retail-3.jpg",
    caseKeys: ["elite"],
    ...
    ru: {
      ...
      seoTitle: "Стеллажи для магазина электроники и телефонов в Ташкенте — RAXPRO",
    ...
    uz: {
      ...
      seoTitle: "Texnika va telefon doʻkoni uchun stellajlar Toshkentda — RAXPRO",
  ...
  base("hoztovary", {
    ...
    uz: {
      ...
      seoTitle: "Xoʻjalik mollari doʻkoni uchun stellajlar Toshkentda — RAXPRO",
  ...
  base("bytovaya-tehnika", {
    cover: "/products/gen/medium-1.jpg",
    caseKeys: ["star", "bloom"],
  ...
  base("gipermarket", {
    ...
    uz: {
      ...
      seoTitle: "Gipermarket va supermarket uchun stellajlar Toshkentda — RAXPRO",
  ...
  base("minimarket", {
    ...
    ru: {
      ...
      seoTitle: "Стеллажи для минимаркета в Ташкенте — пристенные и островные | RAXPRO",
    ...
    uz: {
      ...
      seoTitle: "Minimarket uchun stellajlar Toshkentda — devoriy va orol | RAXPRO",
