...
export const SERVICE_LANDINGS = [
  ...
  },
  {
    ...
    specs: {
      ...
      uz: [{ k: "Toshkent boʻylab", v: "bepul" }, { k: "Viloyatlarga", v: "hajm boʻyicha, narxni hisob toʻlanishidan oldin aytamiz" }, { k: "Kim yigʻadi", v: "shtatdagi oʻz montajchilarimiz" }, { k: "Montajdan keyin", v: "10 yillik kafolat hujjati" }],
    },
    ru: {
    ...
    uz: {
      ...
      points: [
        { t: "Chizma boʻyicha", d: "Avval xonaga mos joylashtirish rejasi, keyin qat’iy shu reja boʻyicha montaj." },
      ...
      faq: [
        { q: "Montaj qancha turadi?", a: "Toshkent boʻylab — bepul. Viloyatlarda montaj va tushirishni loyiha hajmi boʻyicha hisoblaymiz va hisob toʻlanishidan oldin aytamiz." },
  ...
  },
  {
    ...
    uz: {
      ...
      lead: "RAXPRO stellajlariga kafolat — shartnoma boʻyicha 10 yil. Bu bozorda odatda beriladiganidan ikki baravar koʻp. Montajdan keyin kafolat hujjati qoʻlingizga beriladi.",
      points: [
        ...
        { t: "Halol istisnolar", d: "Belgilangan yuklamadan ortiq yuk, texnika zarbasi, mustaqil qayta ishlash va foydalanish qoidalarini buzish — kafolat holati emas." },
      ],
      faq: [
      ...
      seoDesc: "RAXPRO metall stellajlariga kafolat — shartnoma boʻyicha 10 yil, montajdan keyin kafolat hujjati. Kafolat nimani qoplaydi va nimani yoʻq.",
    },
  },
];
