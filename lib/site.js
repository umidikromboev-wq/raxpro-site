...
export const SITE = {
  ...
  // Часы и точка на карте живут только здесь: schema.org берёт их отсюда,
  // чтобы разметка не расходилась с тем, что написано на «Контактах».
  hoursSchema: { days: ["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"], opens: "09:00", closes: "18:00" },
  geo: { lat: 41.3157068, lng: 69.3286053 },
  mapUrl: "https://maps.google.com/?cid=13073703618530234946",
  // Муродбек 25.09: на Google-встройке не было метки RaxPro → карта Яндекса с пином по geo.
  // Когда даст ссылку на карточку организации — заменить yandexMapUrl на неё.
  yandexMapUrl: "https://yandex.uz/maps/?pt=69.328605,41.315707&z=17&l=map",
  yandexMapEmbed: "https://yandex.uz/map-widget/v1/?ll=69.328605%2C41.315707&z=16&pt=69.328605%2C41.315707%2Cpm2rdm",
};
...
export const CLIENT_LOGOS = [
  ...
  { src: "/clients/logo_04.png", alt: "Discovery Invest", note: { ru: "архив офиса, 60 м²", uz: "ofis arxivi, 60 m²" } },
  ...
  { src: "/clients/logo_09.png", alt: "Super Pack", note: { ru: "завод упаковки, паллетные стеллажи", uz: "qadoqlash zavodi, palletli stellajlar" } },
  { src: "/clients/logo_08.png", alt: "Uzum" },
