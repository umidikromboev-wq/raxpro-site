...
export const CASES = [
  ...
  },
  {
    ...
    uz: {
      ...
      task: "Yuklagichlar jadal ishlaydigan avtozavod ehtiyot qismlar ombori: stellajlar faqat ogʻirlikni emas, texnika zarbasini ham koʻtarishi kerak.",
  ...
  // кейс без имени; Mirvali Group названа в их же публичном посте.
  {
    ...
    uz: {
      client: "Avto ehtiyot qismlar ombori",
      title: "Avto ehtiyot qismlar distribyutorining palletli ombori",
      task: "Omborga 120 ta pallet sigʻardi: tovar polda turardi, angar balandligi bekor ketardi.",
      solution: "Butun ombor boʻylab koʻp yarusli palletli stellajlar — yetkazib berish va oʻrnatish bepul.",
      stats: [
  ...
  },
  {
    ...
    uz: {
      ...
      task: "Kompaniya motor moylari sotadi. Stellajlargacha omborga 60 ta pallet sigʻardi.",
      solution: "Ombor balandligi boʻylab palletli stellajlar: tovar yacheykalarga joylangan, har bir palletning oʻz joyi bor.",
      stats: [
        ["60 → 300", "pallet oʻrni"],
        ["×5", "ombor sigʻimi"],
      ],
