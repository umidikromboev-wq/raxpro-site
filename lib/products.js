...
export const PRODUCTS = [
  {
    ...
    levels: 3,
    loadKg: 1000,
    // Конфигуратор (Муродбек 25.09): высота 1–12 м, ярусы по желанию, нагрузка 1–5 т.
    // Цена только у базовой сборки; остальное считает менеджер.
    config: {
      params: ["h", "levels", "load"],
      values: {
        h: [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000],
        levels: [1, 2, 3, 4, 5, 6, 7, 8],
        load: [1000, 1500, 2000, 3000, 4000, 5000],
      },
      base: { h: 4000, levels: 3, load: 1000 },
    },
    ru: {
  ...
  },
  {
    ...
    levels: 4,
    loadKg: 400,
    // Конфигуратор (Муродбек 25.09): высота 2 / 2,5 / 3 м и число полок.
    config: {
      params: ["h", "levels"],
      values: { h: [2000, 2500, 3000], levels: [3, 4, 5, 6] },
      base: { h: 2000, levels: 4 },
    },
    ru: {
    ...
    uz: {
      ...
      seoDesc:
        "RAXPRO oʻrta yuklamali stellaji 2000×2000×600 mm, 4 polka, har biriga 400 kg gacha — 3 620 000 soʻm. Omborda doim mavjud, 10 yil kafolat, Toshkent boʻylab bepul yetkazib berish.",
    },
  },
  {
    ...
    image: "/products/gen/archive-v4.jpg",
    gallery: ["/products/gen/archive-1.jpg", "/products/gen/archive-2.jpg", "/products/gen/archive-3.jpg"],
    ...
    // У каждого варианта своё фото с нужным числом полок — карточка меняет его вместе с ценой.
    variants: [
      { levels: 3, sku: "RX-ARH-2010-3", price: 1000000, image: "/products/gen/archive-v3.jpg" },
      { levels: 4, sku: "RX-ARH-2010-4", price: 1200000, image: "/products/gen/archive-v4.jpg" },
      { levels: 5, sku: "RX-ARH-2010-5", price: 1400000, image: "/products/gen/archive-v5.jpg" },
      { levels: 6, sku: "RX-ARH-2010-6", price: 1600000, image: "/products/gen/archive-v6.jpg" },
    ],
    ru: {
    ...
    uz: {
      ...
      description:
        "RAXPRO arxiv stellaji: balandligi 2000 mm, uzunligi 1000 mm, chuqurligi 400 mm — standart arxiv qutilari va registrator papkalarga moslangan. Boltli birikmadagi uchtadan oltitagacha polka, balandlik boʻyicha qayta oʻrnatish uchun teshikli tayanchlar. Och rangli kukunli boʻyoq chang chiqarmaydi va hujjatlarni ifloslantirmaydi. 1-nav metall, shartnoma boʻyicha 10 yil kafolat.",
      bullets: [
        ...
        "Och rang, chang chiqarmaydi va qogʻozda iz qoldirmaydi",
      ],
      specs: [
        { k: "Balandligi", v: "2000 mm" },
      ...
      seoDesc:
        "RAXPRO arxiv stellaji 2000×1000×400 mm: 3 polka — 1 000 000 soʻm, 4 — 1 200 000, 5 — 1 400 000, 6 — 1 600 000. Har polkaga 300 kg gacha. Arxiv qutilari va papkalar uchun. 10 yil kafolat, Toshkent boʻylab bepul yetkazib berish.",
    },
  },
  ...
  // (PRICED_PRODUCTS), в корзину не кладутся. Размеры и нагрузки — из lib/rack/catalog.ts.
  {
    ...
    uz: {
      ...
      lead: "Katta partiyalarda saqlanadigan bir xil tovar uchun kiriladigan stellaj: yuklagich kanal ichiga kirib palletlarni ichkariga joylaydi. Har bir zich stellaj alohida loyihalanadi va hisoblanadi.",
      description:
        "RAXPRO Toshkentdagi omboridan zich (drive-in) stellaj tizimi. Tayanchlar har 1200 mm da — pallet kengligi boʻyicha, palletlar yon yoʻnaltiruvchilarga tayanadi, kanal chuqurligi 2700 mm ga karrali. LIFO tamoyili: oxirgi kirgan — birinchi chiqadi. 1-nav metall, sinklash va kukunli boʻyoq, tayanch himoyasi va yuklagich kirishi uchun yoʻnaltiruvchilar. Shartnoma boʻyicha 10 yil kafolat.",
      bullets: [
