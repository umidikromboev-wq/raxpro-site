...
export const PRODUCTS = [
  ...
  },
  {
    ...
    uz: {
      ...
      description:
        "RAXPRO arxiv stellaji: balandligi 2000 mm, uzunligi 1000 mm, chuqurligi 400 mm — standart arxiv qutilari va registrator papkalarga moslangan. Boltli birikmadagi toʻrtta polka, balandlik boʻyicha qayta oʻrnatish uchun teshikli tayanchlar. Ochiq rangli kukunli boʻyoq chang chiqarmaydi va hujjatlarni ifloslantirmaydi. 1-nav metall, shartnoma boʻyicha 10 yil kafolat.",
      bullets: [
  ...
  // (PRICED_PRODUCTS), в корзину не кладутся. Размеры и нагрузки — из lib/rack/catalog.ts.
  {
    ...
    ru: {
      ...
      seoDesc:
        "Набивные (drive-in) паллетные стеллажи RAXPRO: до 1500 кг на паллету, глубина канала до 8 паллет, плотность хранения выше на 60%. Проект и расчёт под ваш склад за 24 часа, гарантия 10 лет.",
    },
    uz: {
      ...
      seoDesc:
        "RAXPRO zich (drive-in) paletli stellajlari: har palletga 1500 kg gacha, kanal chuqurligi 8 palletgacha, saqlash zichligi 60% yuqori. Omboringiz uchun 24 soatda loyiha va hisob, 10 yil kafolat.",
    },
  },
  {
    ...
    ru: {
      ...
      seoDesc:
        "Торговые стеллажи RAXPRO для магазинов и торговых залов: пристенные и островные, полки до 150 кг, любой размер под планировку. Бесплатный замер и расчёт за 24 часа, гарантия 10 лет.",
    },
    uz: {
      name: "Savdo stellaji",
      ...
      seoDesc:
        "Doʻkon va savdo zallari uchun RAXPRO savdo stellajlari: devoriy va orol, polkalar 150 kg gacha, tartibga mos istalgan oʻlcham. 24 soatda bepul oʻlchov va hisob, 10 yil kafolat.",
    },
  },
  {
    slug: "mezonin",
    ...
    ru: {
      ...
      seoDesc:
        "Мезонинные системы RAXPRO: второй этаж внутри склада на стеллажных стойках, настил, лестница и ограждение, нагрузка 300–500 кг на ярус. Индивидуальный проект за 24 часа, гарантия 10 лет.",
    },
    uz: {
      name: "Mezonin",
      short: "Mezonin",
      ...
      seoDesc:
        "RAXPRO mezonin tizimlari: stellaj tayanchlarida ombor ichidagi ikkinchi qavat, toʻshama, zinapoya va toʻsiq, har yarusga 300–500 kg. 24 soatda individual loyiha, 10 yil kafolat.",
    },
  },
];
