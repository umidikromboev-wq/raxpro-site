...
// Категория Google: Business & Industrial > Industrial Storage > Industrial Shelving
...
export const PRODUCTS = [
  {
    ...
    image: '/products/palletnyy-stellazh.jpg',
    ...
    ru: {
      ...
      seoTitle: 'Паллетный стеллаж 4000×2700×1050 мм, 3 яруса — цена в Ташкенте | RAXPRO',
      seoDesc:
    ...
    uz: {
      ...
      seoTitle: 'Palletli stellaj 4000×2700×1050 mm, 3 yarus — Toshkentda narxi | RAXPRO',
      seoDesc:
  ...
  },
  {
    ...
    image: '/products/srednegruzovoy-stellazh.jpg',
    ...
    ru: {
      ...
      seoTitle: 'Среднегрузовой стеллаж 2000×2000×600 мм, 4 полки — цена в Ташкенте | RAXPRO',
      seoDesc:
    ...
    uz: {
      ...
      seoTitle: 'Oʻrta yuklamali stellaj 2000×2000×600 mm, 4 polka — Toshkentda narxi | RAXPRO',
      seoDesc:
  ...
  },
  {
    ...
    image: '/products/arhivnyy-stellazh.jpg',
    ...
    ru: {
      ...
      seoTitle: 'Архивный стеллаж 2000×1000×400 мм, 4 полки — цена в Ташкенте | RAXPRO',
      seoDesc:
    ...
    uz: {
      ...
      seoTitle: 'Arxiv stellaji 2000×1000×400 mm, 4 polka — Toshkentda narxi | RAXPRO',
      seoDesc:
